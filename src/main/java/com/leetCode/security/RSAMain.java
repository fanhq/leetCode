...
public class RSAMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //decryptDnaFile(new File("D:\\temp file\\20180321"), aesKey);
...
//            byte[] byteKey = MyRSAUtil.decrypt(pri, Base64.decodeBase64(jsonObject.getString("PASSWD")));
    ...
    private static void dealFile(File file, String srcFile, String destFile, String key) {
        try {
            ...
            if (fileName.toUpperCase().contains(".AVL")) {
                MyAESUtil.decrypt(srcFile, destFile, key);
